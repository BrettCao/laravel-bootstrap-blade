...
use Moddns\BladeExtensions\Directives\DirectiveInterface;
use Moddns\BladeExtensions\Exceptions\InvalidDirectiveClassException;
...
class DirectiveRegistry implements Contracts\DirectiveRegistry
{
    ...
    /**
     * @var array|\Moddns\BladeExtensions\Directives\AbstractDirective[]
     */
    protected $resolved = [];
    ...
    /**
     * {@inheritdoc}
     * @throws \Moddns\BladeExtensions\Exceptions\InvalidDirectiveClassException
     */
