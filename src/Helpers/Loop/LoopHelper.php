...
namespace Moddns\BladeExtensions\Helpers\Loop;

use Moddns\BladeExtensions\Helpers\Loop;
...
class LoopHelper
{
     ...
     *
     * @param \Moddns\BladeExtensions\Helpers\Loop|\Moddns\BladeExtensions\Helpers\Loop\Loop $stackItem
     */
